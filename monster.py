...
#creer une classe qui va gerer la notion de monstre dans le jeu
class Monster(animation.AnimateSprite):
    ...
    def update_health_bar(self, surface):
        ...
        pygame.draw.rect(surface, (51, 64, 55), [self.rect.x + 10, self.rect.y - 20, self.max_health, 5])
        pygame.draw.rect(surface, (30, 184, 81), [self.rect.x + 10, self.rect.y - 20, self.health, 5])
