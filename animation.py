...
class AnimateSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, sprite_name, size=(200, 200)):
        super().__init__()
        self.size = size
        self.image = pygame.image.load(f"C:\\Users\\passi\\OneDrive\\Bibliothèque\\Programmation\\Projets python\\Jeu shooter\\assets\\{sprite_name}.png")
    ...
    def animate(self, loop = False):
        ...
        if self.animation:
            ...
            #verif si on a atteint la fin de l'animation
            if self.current_image >= len(self.images):
                #remetre l'animation au départ
...
#delinir une fonction pour chatrgher les images d'un sprite
def load_animation_images(sprite_name):
    #charger les 24 images de ce sprite dans le dossier correspondant
    images = []
    #récuperer le chemin du dossier pour ce sprite
    path = f"C:\\Users\\passi\\OneDrive\\Bibliothèque\\Programmation\\Projets python\\Jeu shooter\\assets\\{sprite_name}\\{sprite_name}"
